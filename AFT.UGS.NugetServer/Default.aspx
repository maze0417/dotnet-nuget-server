...
<%@ Import Namespace="AFT.UGS.NugetServer.Helper" %>
...
<body>
    <div>
        ...
        <fieldset style="width: 800px">
            ...
            Package Sources:
            <blockquote>
                <strong><%= UrlHelper.GetRepositoryUrl(Request.Url, Request.ApplicationPath) %></strong>
            </blockquote>
            ...
            <blockquote>
                <strong>nuget.exe push {package file} {apikey} -Source <%= UrlHelper.GetPushUrl(Request.Url, Request.ApplicationPath) %></strong>
            </blockquote>
            <% } %>
        </fieldset>
